...
SDL_Quit();
	    ...
	    case SDL_MOUSEMOTION:
			...
			continuer=0;
			break;
		    case SDLK_z: perso.positionimage.y+=5;

 break;
            case SDLK_s:  perso.positionimage.y-=5;
...
SDL_BlitSurface(perso.image,&animepos[frame],screen,&perso.positionimage);
